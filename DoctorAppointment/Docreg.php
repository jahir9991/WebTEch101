...
$unameErr = $fnameErr=$mnameErr= $lnameErr =$picErr= $emailErr = $passErr =$cpassErr= $genderErr ="";
$prule="Ex:  Aaaaaaaa8"; $urule="Ex:  aabbc1_@";
$uname = $fname = $mname = $lname  = $pass=$cpass = $email = $dept = $gender ="";
$cnt=true;
...
<fieldset  id="bn" width="100%">
    ...
    <form action="Docreg.php" method="post" enctype="multipart/form-data" >
        ...
        <tr>
            ...
            <td class="error" > <input type="text" name="lname" value="<?=$qualification?>" />*</td>
            <td> <span class="error"><?=$qualificErr?></span></td>
        </tr>
        <tr>
            <td align="right">  Designation : </td>
            <td class="error" > <input type="text" name="lname" value="<?=$designation?>" />*</td>
            <td> <span class="error"><?=$desigErr?></span></td>
        </tr>
        <tr>
            <td align="right">  Experts : </td>
            <td class="error" > <input type="text" name="lname" value="<?=$experts?>" />*</td>
            <td> <span class="error"><?=$expertErr?></span></td>
        </tr>
        ...
        <tr>
            ...
            <td class="error"> <input type="text" name="email"value="<?=phone1?>"/>*</td>
            <td> <span class="error"><?=$phone1Err?></span></td>

        <tr>
        <tr>
            <td align="right"> Phone (2): </td>
            <td class="error"> <input type="text" name="email"value="<?=phone2?>"/>*</td>
            <td> <span class="error"><?=$phone2Err?></span></td>

        <tr>

        <tr>
            <td align="right"> Hospital : </td>
            <td class="error"> <input type="text" name="email"value="<?=hospital?>"/>*</td>
            <td> <span class="error"><?=$hospitalErr?></span></td>

        <tr>
        <tr>
            <td align="right"> Location : </td>
            <td class="error"> <input type="text" name="email"value="<?=location?>"/>*</td>
            <td> <span class="error"><?=$locationErr?></span></td>
